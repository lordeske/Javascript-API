...
const allCategories = {  /// all categ object
...
const timeAgo = (time) => {
    ...
    const lastPost = new Date(time); ///last post date

    const timeDifference = currentTime - lastPost ; // in milisec
...
const showLatestPosts = (data) => {
  ...
  const { topics } = topic_list;
    ...
    postsContainer.innerHTML =  topics.map((item)=>{
        ...
        return `<tr>
        <td><a href="${forumTopicUrl}${slug}/${id}" target="_blank" class="post-title">${title}</a>
